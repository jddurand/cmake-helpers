function(cmake_helpers_init)
  ...
  if(NOT C_NAN)
    block()
      set(CMAKE_HELPERS_TRY_RUN_COMPILE_DEFINITIONS -DC_NAN=NAN -DHAVE_NAN_REPLACEMENT)
      cmake_helpers_try_run(C_NAN_REPLACEMENT ${PROJECT_SOURCE_DIR}/cmake/NAN.c)
    endblock()
  endif()
  if(NOT C_NAN_REPLACEMENT)
    block()
      set(CMAKE_HELPERS_TRY_RUN_COMPILE_DEFINITIONS -DC_NAN=NAN -DHAVE_NAN_REPLACEMENT_USING_DIVISION)
