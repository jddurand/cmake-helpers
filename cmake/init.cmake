function(cmake_helpers_init)
  ...
  if(CMAKE_C_COMPILER_ID MATCHES "Clang|GNU")
    ...
    if(C_COMPILER_HAS_WERROR_OPTION)
	  ...
	  string(TOUPPER ${_attribute} _attribute_topupper)
          set(CMAKE_HELPERS_TRY_RUN_COMPILE_DEFINITIONS -DC_GCC_FUNC_ATTRIBUTE_${_attribute_topupper})
  ...
  block()
	...
	message(STATUS "${_output_gen_dir} should be added by caller to its include path")
      endif()
    endif()
  endblock()
  #
