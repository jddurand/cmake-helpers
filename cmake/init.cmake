function(cmake_helpers_init)
  ...
  set(CMAKE_HELPERS_TRY_RUN_COMPILE_DEFINITIONS)
  cmake_helpers_init_check_include_file("ctype.h"        HAVE_CTYPE_H)
  cmake_helpers_init_check_include_file("errno.h"        HAVE_ERRNO_H)
  cmake_helpers_init_check_include_file("fcntl.h"        HAVE_FCNTL_H)
  cmake_helpers_init_check_include_file("features.h"     HAVE_FEATURES_H)
  cmake_helpers_init_check_include_file("float.h"        HAVE_FLOAT_H)
  cmake_helpers_init_check_include_file("inttypes.h"     HAVE_INTTYPES_H)
  cmake_helpers_init_check_include_file("io.h"           HAVE_IO_H)
  cmake_helpers_init_check_include_file("langinfo.h"     HAVE_LANGINFO_H)
  cmake_helpers_init_check_include_file("limits.h"       HAVE_LIMITS_H)
  cmake_helpers_init_check_include_file("locale.h"       HAVE_LOCALE_H)
  cmake_helpers_init_check_include_file("math.h"         HAVE_MATH_H)
  cmake_helpers_init_check_include_file("memory.h"       HAVE_MEMORY_H)
  cmake_helpers_init_check_include_file("poll.h"         HAVE_POLL_H)
  cmake_helpers_init_check_include_file("process.h"      HAVE_PROCESS_H)
  cmake_helpers_init_check_include_file("pwd.h"          HAVE_PWD_H)
  cmake_helpers_init_check_include_file("regex.h"        HAVE_REGEX_H)
  cmake_helpers_init_check_include_file("signal.h"       HAVE_SIGNAL_H)
  cmake_helpers_init_check_include_file("stdarg.h"       HAVE_STDARG_H)
  cmake_helpers_init_check_include_file("stddef.h"       HAVE_STDDEF_H)
  cmake_helpers_init_check_include_file("stdint.h"       HAVE_STDINT_H)
  cmake_helpers_init_check_include_file("stdio.h"        HAVE_STDIO_H)
  cmake_helpers_init_check_include_file("stdlib.h"       HAVE_STDLIB_H)
  cmake_helpers_init_check_include_file("string.h"       HAVE_STRING_H)
  cmake_helpers_init_check_include_file("strings.h"      HAVE_STRINGS_H)
  cmake_helpers_init_check_include_file("sys/inttypes.h" HAVE_SYS_INTTYPES_H)
  cmake_helpers_init_check_include_file("sys/stat.h"     HAVE_SYS_STAT_H)
  cmake_helpers_init_check_include_file("sys/stdint.h"   HAVE_SYS_STDINT_H)
  cmake_helpers_init_check_include_file("sys/time.h"     HAVE_SYS_TIME_H)
  cmake_helpers_init_check_include_file("sys/types.h"    HAVE_SYS_TYPES_H)
  cmake_helpers_init_check_include_file("time.h"         HAVE_TIME_H)
  cmake_helpers_init_check_include_file("unistd.h"       HAVE_UNISTD_H)
  cmake_helpers_init_check_include_file("utime.h"        HAVE_UTIME_H)
  cmake_helpers_init_check_include_file("wchar.h"        HAVE_WCHAR_H)
  cmake_helpers_init_check_include_file("wctype.h"       HAVE_WCTYPE_H)
  cmake_helpers_init_check_include_file("windows.h"      HAVE_WINDOWS_H)
  #
  # Check math library
  #
  ...
  if(CMAKE_C_COMPILER_ID MATCHES "Clang|GNU")
    ...
    check_c_compiler_flag("-Werror=attributes" C_COMPILER_HAS_WERROR_ATTRIBUTES_OPTION)
    if(C_COMPILER_HAS_WERROR_ATTRIBUTES_OPTION)
      block()
        list(APPEND CMAKE_C_FLAGS "-Werror=attributes")
  ...
  if(((NOT DEFINED HAVE_STDINT_H) OR (NOT HAVE_STDINT_H)) AND CMAKE_HELPERS_GENERATE_STDINT_H)
    ...
    if(NOT EXISTS ${_output_file})
      ...
      message(STATUS "${_output_file} already exist")
    endif()
...
macro(cmake_helpers_init_check_include_file header have_var)
  check_include_file(${header} ${have_var})
  if(${var})
    list(APPEND CMAKE_HELPERS_TRY_RUN_COMPILE_DEFINITIONS -D${have_var})
  endif()
endmacro()
