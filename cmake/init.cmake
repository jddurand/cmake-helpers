function(cmake_helpers_init)
  ...
  block()
    ...
    if((NOT HAVE_STDINT_H) AND CMAKE_HELPERS_GENERATE_STDINT_H)
      set(_output_file ${CMAKE_CURRENT_BINARY_DIR}/${CMAKE_INSTALL_INCLUDEDIR}/stdint.h)
    ...
    if((NOT HAVE_INTTYPES_H) AND CMAKE_HELPERS_GENERATE_INTTYPES_H)
      set(_output_file ${CMAKE_CURRENT_BINARY_DIR}/${CMAKE_INSTALL_INCLUDEDIR}/inttypes.h)
      message(STATUS "Generating ${_output_file}")
