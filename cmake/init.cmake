function(cmake_helpers_init)
  ...
  if(NOT DEFINED HAVE_STDINT_H)
    ...
    message(STATUS "[DEBUG] (NOT DEFINED HAVE_STDINT_H) return FALSE, value is: ${HAVE_STDINT_H}")
  endif()
  ...
  if(NOT DEFINED HAVE_INTTYPES_H)
    ...
    message(STATUS "[DEBUG] (NOT DEFINED HAVE_INTTYPES_H) return FALSE, value is: ${HAVE_INTTYPES_H}")
  endif()
