function(cmake_helpers_init)
  ...
  cmake_helpers_try_run(C_INFINITY ${PROJECT_SOURCE_DIR}/cmake/HUGE_VALL.c INFINITY)
  if(NOT C_INFINITY)
    block()
      set(CMAKE_HELPERS_TRY_RUN_COMPILE_DEFINITIONS -DC_INFINITY=INFINITY -DHAVE_INFINITY_REPLACEMENT)
      cmake_helpers_try_run(C_INFINITY_REPLACEMENT ${PROJECT_SOURCE_DIR}/cmake/HUGE_VALL.c)
    endblock()
  endif()
  if(NOT C_INFINITY_REPLACEMENT)
    block()
      set(CMAKE_HELPERS_TRY_RUN_COMPILE_DEFINITIONS -DC_INFINITY=INFINITY -DHAVE_INFINITY_REPLACEMENT_USING_DIVISION)
      cmake_helpers_try_run(C_INFINITY_REPLACEMENT_USING_DIVISION ${PROJECT_SOURCE_DIR}/cmake/HUGE_VALL.c)
    endblock()
  endif()
  #
  # Check GNU features
