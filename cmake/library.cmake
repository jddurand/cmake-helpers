...
foreach(_cmake_helpers_library_install_target @_cmake_helpers_library_install_targets@)
  ...
  if(_cmake_helpers_library_target_type STREQUAL "INTERFACE_LIBRARY")
    ...
    #
    # We remove the suffix(es)
    #
    cmake_path(GET _cmake_helpers_library_target_filename EXTENSION _cmake_helpers_library_target_filename_extension)
    if(_cmake_helpers_library_target_filename_extension)
      string(LENGTH "${_cmake_helpers_library_target_filename_extension}" _cmake_helpers_library_target_filename_extension_length)
      string(LENGTH "${_cmake_helpers_library_target_filename}" _cmake_helpers_library_target_filename_length)
      math(EXPR _cmake_helpers_library_target_filename_length_without_extension "${_cmake_helpers_library_target_filename_length} - ${_cmake_helpers_library_target_filename_extension_length}")
      string(SUBSTRING "${_cmake_helpers_library_target_filename}" 0 ${_cmake_helpers_library_target_filename_length_without_extension} _cmake_helpers_library_target_filename_without_extension)
    else()
      message(WARNING "Could not find extension in \"${_cmake_helpers_library_target_filename}\"")
      set(_cmake_helpers_library_target_filename_without_extension ${_cmake_helpers_library_target_filename})
    endif()
    #
    ...
    if(_cmake_helpers_library_target_type STREQUAL "STATIC_LIBRARY")
      if(NOT("x${CMAKE_STATIC_LIBRARY_PREFIX}" STREQUAL "x"))
        if(_cmake_helpers_library_target_filename_without_extension MATCHES "^${CMAKE_STATIC_LIBRARY_PREFIX}(.+)")
          set(_cmake_helpers_library_target_filename_without_extension ${CMAKE_MATCH_1}) 
        endif()
      endif()
    elseif(_cmake_helpers_library_target_type STREQUAL "SHARED_LIBRARY")
      if(NOT("x${CMAKE_SHARED_LIBRARY_PREFIX}" STREQUAL "x"))
        if(_cmake_helpers_library_target_filename_without_extension MATCHES "^${CMAKE_SHARED_LIBRARY_PREFIX}(.+)")
          set(_cmake_helpers_library_target_filename_without_extension ${CMAKE_MATCH_1}) 
        endif()
      endif()
    endif()
