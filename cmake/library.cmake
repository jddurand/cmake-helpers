function(cmake_helpers_library name)
  ...
  if(_cmake_helpers_config)
    ...
    set(_cmake_helpers_config_out "${CMAKE_CURRENT_BINARY_DIR}/${_cmake_helpers_outputdir}/${_cmake_helpers_config_out}")
    cmake_helpers_call(configure_file ${_cmake_helpers_config_in} ${_cmake_helpers_config_out})
    cmake_helpers_call(source_group TREE ${CMAKE_CURRENT_BINARY_DIR} FILES ${_cmake_helpers_config_out})
  else()
