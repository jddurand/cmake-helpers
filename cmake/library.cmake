function(cmake_helpers_library name)
  ...
  foreach(_cmake_helpers_library_target IN LISTS _cmake_helpers_library_targets)
	...
	cmake_helpers_call(target_compile_definitions ${_cmake_helpers_library_target} PUBLIC ${_cmake_helpers_library_object_public_defines})
      ...
      #
      # Take care: we have internal object libraries that can be proxies to shared, static and module libraries
      #
	...
	#
	# The same code as below for SHARED, STATIC and MODULE library types
	#
	...
	elseif(_cmake_helpers_library_target_proxy_type STREQUAL "MODULE_LIBRARY")
	  if(_cmake_helpers_library_module_private_defines)
	    cmake_helpers_call(target_compile_definitions ${_cmake_helpers_library_target} PRIVATE ${_cmake_helpers_library_module_private_defines})
	  endif()
	  if(_cmake_helpers_library_module_public_defines)
