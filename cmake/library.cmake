function(cmake_helpers_library name)
  ...
  set(_cmake_helpers_sources_auto_globs                  src/*.c src/*.cpp src/*.cxx)
  set(_cmake_helpers_headers)
  set(_cmake_helpers_headers_auto_base_dirs              ${PROJECT_SOURCE_DIR})
  set(_cmake_helpers_headers_auto_globs                  include/*.h include/*.hh include/*.hpp include/*.hxx)
