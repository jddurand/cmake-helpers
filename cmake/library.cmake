function(cmake_helpers_library name)
  ...
  set(_oneValueArgs
    ...
    EXPORT_HEADER_SHARED_EXPORTS_DEFINE
    NTRACE
    TARGETS_OUTVAR
    ADD_VERSION_DEFINES
    INTERNAL
  ...
  set(_cmake_helpers_library_export_header_base_name              ${name})
  set(_cmake_helpers_library_export_header_macro_name             ${name}_EXPORT)
  set(_cmake_helpers_library_export_header_file_name              include/${name}/export.h)
  set(_cmake_helpers_library_export_header_static_define          ${name}_STATIC)
  set(_cmake_helpers_library_export_header_shared_exports_define  ${name}_EXPORTS)
  ...
  foreach(_cmake_helpers_library_type IN LISTS _cmake_helpers_library_types)
	...
	(_cmake_helpers_library_target_type STREQUAL "MODULE_LIBRARY")
      ...
      cmake_helpers_call(add_library objs_${_cmake_helpers_library_target} OBJECT EXCLUDE_FROM_ALL ${_cmake_helpers_library_sources})
	...
	cmake_helpers_call(target_compile_options objs_${_cmake_helpers_library_target} ${_cmake_helpers_library_type_any_compile_options})
      ...
      cmake_helpers_call(set_target_properties objs_${_cmake_helpers_library_target} PROPERTIES CMAKE_HELPERS_LIBRARY_TARGET_PROXY ${_cmake_helpers_library_target})
  ...
  foreach(_cmake_helpers_library_target IN LISTS _cmake_helpers_library_targets)
    ...
    # Compile definitions
    #
    get_target_property(_cmake_helpers_library_target_proxy ${_cmake_helpers_library_target} CMAKE_HELPERS_LIBRARY_TARGET_PROXY)
    if(_cmake_helpers_library_target_proxy AND (TARGET ${_cmake_helpers_library_target_proxy}))
      get_target_property(_cmake_helpers_library_target_proxy_type ${_cmake_helpers_library_target_proxy} TYPE)
    else()
      set(_cmake_helpers_library_target_proxy_type)
    endif()
    if((_cmake_helpers_library_target_type STREQUAL "SHARED_LIBRARY") OR (_cmake_helpers_library_target_proxy_type STREQUAL "SHARED_LIBRARY"))
    ...
    elseif((_cmake_helpers_library_target_type STREQUAL "STATIC_LIBRARY") OR (_cmake_helpers_library_target_proxy_type STREQUAL "STATIC_LIBRARY"))
    ...
    elseif((_cmake_helpers_library_target_type STREQUAL "MODULE_LIBRARY") OR (_cmake_helpers_library_target_proxy_type STREQUAL "MODULE_LIBRARY"))
    ...
    elseif((_cmake_helpers_library_target_type STREQUAL "INTERFACE_LIBRARY") OR (_cmake_helpers_library_target_proxy_type STREQUAL "INTERFACE_LIBRARY"))
    ...
    if((_cmake_helpers_library_target_type STREQUAL "SHARED_LIBRARY") OR (_cmake_helpers_library_target_type STREQUAL "MODULE_LIBRARY"))
      if(NOT $ENV{CMAKE_HELPERS_NAMELINK_SKIP})
	...
	cmake_helpers_call(set_property TARGET ${_cmake_helpers_library_target} PROPERTY MSVC_DEBUG_INFORMATION_FORMAT "$<$<CONFIG:Debug,RelWithDebInfo>:Embedded>")
...
foreach(_cmake_helpers_library_install_target @_cmake_helpers_library_install_targets@)
  ...
  set(_requires)
  if(PKG_CONFIG_FOUND)
    if(_cmake_helpers_library_links)
      foreach(_cmake_helpers_library_link IN LISTS _cmake_helpers_library_links)
        if(CMAKE_HELPERS_DEBUG)
          message(STATUS "[${_cmake_helpers_logprefix}] ... ... Looking at public link library ${_cmake_helpers_library_link}")
        endif()
        #
        # Special case of link only dependencies: <$LINK_ONLY:xxx>
        #
        if("${_cmake_helpers_library_link}" MATCHES "^\\\$<LINK_ONLY:(.*)>\$")
          if("x${CMAKE_MATCH_1}" STREQUAL "x")
            continue()
          endif()
          if(CMAKE_HELPERS_DEBUG)
            message(STATUS "[${_cmake_helpers_logprefix}] ... ... ... ${_cmake_helpers_library_link} <- ${CMAKE_MATCH_1}")
          endif()
          set(_cmake_helpers_library_link ${CMAKE_MATCH_1})
        endif()
        if(TARGET ${_cmake_helpers_library_link})
          if(CMAKE_HELPERS_DEBUG)
            message(STATUS "[${_cmake_helpers_logprefix}] ... ... ... ${_cmake_helpers_library_link}: Target exist")
          endif()
          if("${_cmake_helpers_library_link}" MATCHES "^.*::(.+)\$")
            if("x${CMAKE_MATCH_1}" STREQUAL "x")
              continue()
            endif()
            if(CMAKE_HELPERS_DEBUG)
          ...
          if(NOT _cmake_helpers_library_link IN_LIST _requires)
            if(CMAKE_HELPERS_DEBUG)
            ...
            if(CMAKE_HELPERS_DEBUG)
              message(STATUS "[${_cmake_helpers_logprefix}] ... ... ... ... pkg_check_modules(PC_${_cmake_helpers_library_link} ${_cmake_helpers_library_link}) skipped - already found")
            endif()
          endif()
        else()
          if(CMAKE_HELPERS_DEBUG)
            message(STATUS "[${_cmake_helpers_logprefix}] ... ... ... ${_cmake_helpers_library_link}: No such target")
          endif()
        endif()
      endforeach()
  ...
  if(_cmake_helpers_library_private_links)
    foreach(_cmake_helpers_library_private_link IN LISTS _cmake_helpers_library_private_links)
      if(CMAKE_HELPERS_DEBUG)
        message(STATUS "[${_cmake_helpers_logprefix}] ... ... Looking at private link library ${_cmake_helpers_library_private_link}")
      endif()
      #
      # Special case of link only dependencies: <$LINK_ONLY:xxx>
      #
      if("${_cmake_helpers_library_private_link}" MATCHES "^\\\$<LINK_ONLY:(.*)>\$")
        if("x${CMAKE_MATCH_1}" STREQUAL "x")
          continue()
        endif()
        if(CMAKE_HELPERS_DEBUG)
          message(STATUS "[${_cmake_helpers_logprefix}] ... ... ... ${_cmake_helpers_library_private_link} <- ${CMAKE_MATCH_1}")
        endif()
        set(_cmake_helpers_library_private_link ${CMAKE_MATCH_1})
      endif()
      if(TARGET ${_cmake_helpers_library_private_link})
        if(CMAKE_HELPERS_DEBUG)
          message(STATUS "[${_cmake_helpers_logprefix}] ... ... ... ${_cmake_helpers_library_private_link}: Target exist")
        endif()
        if("${_cmake_helpers_library_private_link}" MATCHES "^.*::(.+)\$")
          if("x${CMAKE_MATCH_1}" STREQUAL "x")
            continue()
          endif()
          if(CMAKE_HELPERS_DEBUG)
        ...
        if(NOT _cmake_helpers_library_private_link IN_LIST _requires_private)
          if(CMAKE_HELPERS_DEBUG)
            message(STATUS "[${_cmake_helpers_logprefix}] ... ... ... ... pkg_check_modules(PC_${_cmake_helpers_library_private_link} ${_cmake_helpers_library_private_link})")
          endif()
          set(PC_${_cmake_helpers_library_private_link}_FOUND "")
          pkg_check_modules(PC_${_cmake_helpers_library_private_link} ${_cmake_helpers_library_private_link})
          if(PC_${_cmake_helpers_library_private_link}_FOUND)
            list(APPEND _requires_private ${_cmake_helpers_library_private_link})
          endif()
        else()
          if(CMAKE_HELPERS_DEBUG)
            message(STATUS "[${_cmake_helpers_logprefix}] ... ... ... ... pkg_check_modules(PC_${_cmake_helpers_library_private_link} ${_cmake_helpers_library_private_link}) skipped - already found")
          endif()
        endif()
      else()
        if(CMAKE_HELPERS_DEBUG)
          message(STATUS "[${_cmake_helpers_logprefix}] ... ... ... ${_cmake_helpers_library_private_link}: No such target")
        endif()
      endif()
    endforeach()
