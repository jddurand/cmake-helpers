function(cmake_helpers_library name)
  ...
  if((NOT _cmake_helpers_private_headers) AND _cmake_helpers_private_headers_auto)
    foreach(_source ${_cmake_helpers_sources})
      ...
      if (_accept_matched)
	if(CMAKE_HELPERS_DEBUG)
	  message(STATUS "[library] ${source} matches accept regexes: ${_cmake_helpers_sources_auto_iface_relpath_accept_regexes}")
	endif()
	...
	if(_private_matched)
	  if(CMAKE_HELPERS_DEBUG)
	    message(STATUS "[library] ${source} matches private regexes: ${_cmake_helpers_sources_auto_iface_relpath_private_regexes}")
	  endif()
