function(cmake_helpers_library name)
  ...
  if(_cmake_helpers_config_args)
    if(CMAKE_HELPERS_DEBUG)
      message(STATUS "[library] -------------------")
      message(STATUS "[library] Doing configuration")
      message(STATUS "[library] -------------------")
    endif()
  ...
  foreach(_target ${_targets})
    ...
    if(CMAKE_HELPERS_DEBUG)
      message(STATUS "[library] ----------------------------")
      message(STATUS "[library] Doing ${_type} setting")
      message(STATUS "[library] ----------------------------")
    endif()
    #
  ...
  if(CMAKE_HELPERS_DEBUG)
    message(STATUS "[library] ---------------------")
    message(STATUS "[library] Setting install rules")
    message(STATUS "[library] ---------------------")
  endif()
  if(_cmake_helpers_public_headers)
...
")
  ...
  if(_cmake_helpers_pkgconfig)
    if(CMAKE_HELPERS_DEBUG)
      message(STATUS "[library] ------------------------")
      message(STATUS "[library] Creating pkgconfig hooks")
      message(STATUS "[library] ------------------------")
    endif()
    file(CONFIGURE
...
"
  ...
  if(_cmake_helpers_package)
    ...
    if(CMAKE_SOURCE_DIR STREQUAL PROJECT_SOURCE_DIR)
      ...
      if(CMAKE_HELPERS_DEBUG)
	message(STATUS "[library] -------------------------")
	message(STATUS "[library] Doing CPack configuration")
	message(STATUS "[library] -------------------------")
      endif()
