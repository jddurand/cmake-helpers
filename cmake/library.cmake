...
"
  ...
  if(_cmake_helpers_package)
    ...
    if(CMAKE_SOURCE_DIR STREQUAL PROJECT_SOURCE_DIR)
      ...
      if(CMAKE_HELPERS_DEBUG)
	message(STATUS "[${PROJECT_NAME}/library] -------------------------")
	message(STATUS "[${PROJECT_NAME}/library] Doing CPack configuration")
	message(STATUS "[${PROJECT_NAME}/library] -------------------------")
      endif()
    ...
    if(CMAKE_HELPERS_DEBUG)
      message(STATUS "[${PROJECT_NAME}/library] Development group : ${_can_developmentgroup}")
      message(STATUS "[${PROJECT_NAME}/library] Library group     : ${_can_librarygroup}")
      message(STATUS "[${PROJECT_NAME}/library] Document group    : ${_can_documentgroup}")
      message(STATUS "[${PROJECT_NAME}/library] Runtime group     : ${_can_runtimegroup}")
    endif()
