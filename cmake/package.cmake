function(cmake_helpers_package)
  ...
  #
  set(_cmake_helpers_package_extra_licenses)
  #
  # Parse Arguments
  #
  ...
  if(_cmake_helpers_package_license)
    list(APPEND _all_licenses ${PROJECT_NAME} ${_cmake_helpers_package_license})
  endif()
  if(_cmake_helpers_package_extra_licenses)
    list(APPEND _all_licenses ${_cmake_helpers_package_extra_licenses})
  endif()
  if(_all_licenses)
    list(LENGTH _all_licenses _all_licenses_length)
    math(EXPR _all_licenses_length_i_max "(${_all_licenses_length} / 2) - 1")
    set(_j -1)
    foreach(_i RANGE 0 ${_all_licenses_length_i_max})
      ...
      if(CMAKE_HELPERS_DEBUG)
	message(STATUS "[${_cmake_helpers_logprefix}] Looking at License file for project ${_license_project_name}: ${_license}")
      endif()
      if(EXISTS ${_license})
	#
	# Licenses count
	...
	message(WARNING "License file not found for project ${_license_project_name}: ${_license}")
      endif()
    endforeach()
  endif()
  #
