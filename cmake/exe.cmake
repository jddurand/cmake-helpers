Function(cmake_helpers_exe name)
  ...
  set(_cmake_helpers_exe_exe_using_shared_library    TRUE)
  ...
  set(_cmake_helpers_exe_install_targets)
  ...
  foreach(_cmake_helpers_exe_library_target ${_cmake_helpers_exe_library_targets})
	...
	if(NOT _cmake_helpers_exe_exe_using_static_library)
	  continue()
	else()
	...
	if(NOT _cmake_helpers_exe_exe_using_interface_library)
	  continue()
	else()
	...
	foreach(_cmake_helpers_exe_environment IN LISTS _cmake_helpers_exe_environments)
	  ...
	  if(_cmake_helpers_exe_test_sep STREQUAL ";")
	    string(REPLACE ";" "\\$<SEMICOLON>" _cmake_helpers_exe_native_environment "${_cmake_helpers_exe_native_environment}")
	  endif()
	  if(CMAKE_HELPERS_DEBUG)
  ...
  if(_libraries)
	...
	if(_is_imported)
	  ...
	  if(
	    ...
	    list(APPEND _locations $<SHELL_PATH:$<PATH:ABSOLUTE_PATH,NORMALIZE,$<TARGET_FILE_DIR:${_library}>,${CMAKE_CURRENT_BINARY_DIR}>>)
	    if(CMAKE_HELPERS_DEBUG)
	      message(STATUS "[${_cmake_helpers_logprefix}] Link library ${_library} is not an imported target, using $<SHELL_PATH:$<PATH:ABSOLUTE_PATH,NORMALIZE,$<TARGET_FILE_DIR:${_library}>,${CMAKE_CURRENT_BINARY_DIR}>>")
	    endif()
	  else()
	    if(CMAKE_HELPERS_DEBUG)
