function(cmake_helpers_depend depname)
  ...
  string(TOUPPER "CMAKE_HELPERS_DEPEND_${depname}_FILE" _env_cmake_helpers_depend_file_toupper)
  string(REGEX REPLACE "[^a-zA-Z0-9_]" "_" _env_cmake_helpers_depend_file_toupper ${_env_cmake_helpers_depend_file_toupper})
  if((NOT("x$ENV{${_env_cmake_helpers_depend_file_toupper}}" STREQUAL "x")) AND (EXISTS $ENV{${_env_cmake_helpers_depend_file_toupper}}))
    set(_cmake_helpers_depend_file                          $ENV{${_env_cmake_helpers_depend_file_toupper}})
  else()
