function(cmake_helpers_pod)
  ...
  if(_cmake_helpers_pod_pod2man)
	...
	DEPENDS ${_cmake_helpers_pod_input}
      ...
      #
      cmake_helpers_call(set_property DIRECTORY ${CMAKE_CURRENT_BINARY_DIR} APPEND PROPERTY ADDITIONAL_CLEAN_FILES ${_cmake_helpers_pod_gzip_output} ${_cmake_helpers_pod_output})
      #
