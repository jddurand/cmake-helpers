function(cmake_helpers_pod)
  ...
  if(NOT ${_cmake_helpers_pod_namespace} IN_LIST _cmake_helpers_namespaces)
    cmake_helpers_call(set_property DIRECTORY ${CMAKE_BINARY_DIR} APPEND PROPERTY cmake_helpers_namespaces ${_cmake_helpers_pod_namespace})
  endif()

  foreach(_cmake_helpers_component_type man html)
    cmake_helpers_call(set_property DIRECTORY ${CMAKE_BINARY_DIR} PROPERTY cmake_helpers_have_${_cmake_helpers_pod_namespace}_${_cmake_helpers_component_type}_component ${_cmake_helpers_have_${_cmake_helpers_pod_namespace}_${_cmake_helpers_component_type}_component})
    ...
    if(${_cmake_helpers_have_${_cmake_helpers_pod_namespace}_${_cmake_helpers_component_type}_component})
      cmake_helpers_call(set_property DIRECTORY ${CMAKE_BINARY_DIR} PROPERTY cmake_helpers_${_cmake_helpers_component}_${_cmake_helpers_pod_namespace}_component_name ${_cmake_helpers_pod_${_cmake_helpers_component_type}_component_name})
